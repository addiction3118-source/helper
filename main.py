...
ANALYZE_SYSTEM = (
    ...
    "разработки. ВАЖНО: у него НЕТ навыков программирования — он умеет лишь "
    "собирать решения через ИИ и no-code. Если заказ требует ручного кодинга, "
    "отладки, знания фреймворков или инженерного опыта — ставь fit=hard или no. "
